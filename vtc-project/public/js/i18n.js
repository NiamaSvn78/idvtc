(function () {
  ...
  var T = {
    fr: {
      ...
      'airport.qr_notice_html': 'Un <strong>QR code obligatoire</strong> vous sera remis après validation WhatsApp — à présenter au conducteur sans exception.',
      ...
      'transfer.qr_notice_html': 'Un <strong>QR code obligatoire</strong> vous sera remis après validation WhatsApp — à présenter au conducteur sans exception.',
      ...
      'mad.qr_notice_html': 'Un <strong>QR code obligatoire</strong> vous sera remis après validation WhatsApp — à présenter au conducteur sans exception.',
      ...
      'guar.g6_desc': 'Après validation WhatsApp, un QR code unique vous est remis. Votre conducteur doit impérativement le scanner avant le départ — sans lui, aucune course ne peut démarrer.',
      ...
      'modal.sub': 'Renseignez vos coordonnées puis envoyez votre réservation sur WhatsApp.',
      ...
      'modal.card': 'Paiement traité ensuite par WhatsApp',
      'modal.confirm': 'Confirmer et envoyer sur WhatsApp',
      'modal.suc_title': 'Réservation confirmée !',
      'modal.qr_warning_html': 'Ce QR code est <strong>indispensable</strong> : il mentionne que le paiement n\'a pas encore été effectué et le mode choisi. Votre chauffeur ne peut démarrer la course sans l\'avoir scanné.',
      ...
      'modal.email_fail_html': '<strong>Attention :</strong> la réservation est enregistrée mais l\'email de confirmation n\'a pas pu être envoyé. Conservez ce QR code ou contactez-nous par WhatsApp.',
      'modal.close': 'Fermer',
    ...
    en: {
      ...
      'airport.qr_notice_html': 'A <strong>mandatory QR code</strong> will be sent after WhatsApp validation — must be shown to the driver without exception.',
      ...
      'transfer.qr_notice_html': 'A <strong>mandatory QR code</strong> will be sent after WhatsApp validation — must be shown to the driver without exception.',
      ...
      'mad.qr_notice_html': 'A <strong>mandatory QR code</strong> will be sent after WhatsApp validation — must be shown to the driver without exception.',
      ...
      'guar.g6_desc': 'After WhatsApp validation, a unique QR code is issued to you. Your driver must scan it before departure — without it, no ride can begin.',
      ...
      'modal.sub': 'Enter your details then send your booking via WhatsApp.',
      ...
      'modal.card': 'Payment handled afterwards via WhatsApp',
      'modal.confirm': 'Confirm and send via WhatsApp',
      'modal.suc_title': 'Booking confirmed!',
      'modal.qr_warning_html': 'This QR code is <strong>essential</strong>: it states that payment has not yet been made and shows the selected method. Your driver cannot start the ride without scanning it.',
      ...
      'modal.email_fail_html': '<strong>Note:</strong> your booking was saved but the confirmation email could not be sent. Save this QR code or contact us on WhatsApp.',
      'modal.close': 'Close',
