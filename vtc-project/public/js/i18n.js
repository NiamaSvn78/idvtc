(function () {
  ...
  var T = {
    fr: {
      ...
      'airport.secure': 'Finalisation sur WhatsApp · Pas de paiement par carte sur ce site pour le moment',
      ...
      'transfer.secure': 'Finalisation sur WhatsApp · Pas de paiement par carte sur ce site pour le moment',
      ...
      'mad.pay': 'Réserver',
      'mad.secure': 'Finalisation sur WhatsApp · Pas de paiement par carte sur ce site pour le moment',
      ...
      'modal.sub': 'Renseignez vos coordonnées. La confirmation et le règlement se font pour l’instant sur WhatsApp.',
    ...
    en: {
      ...
      'airport.pay': 'Book',
      'airport.secure': 'Completed via WhatsApp · No card payment on this site for now',
      ...
      'transfer.pay': 'Book',
      'transfer.secure': 'Completed via WhatsApp · No card payment on this site for now',
      ...
      'mad.pay': 'Book',
      'mad.secure': 'Completed via WhatsApp · No card payment on this site for now',
      ...
      'modal.sub': 'Enter your details. Confirmation and payment are handled on WhatsApp for now.',
