(function () {
  ...
  var T = {
    fr: {
      ...
      'airport.van_model': 'Mercedes Classe V',
      ...
      'airport.pay': 'Payer par carte',
      'airport.secure': '🔒 Paiement sécurisé · Stripe',
      'airport.or_sep': 'ou réserver sans paiement immédiat',
      'airport.wa': 'Réserver via WhatsApp',
      'airport.qr_notice_html': 'Un <strong>QR code obligatoire</strong> vous sera remis après paiement — à présenter au conducteur sans exception.',
      ...
      'transfer.pay': 'Payer par carte',
      'transfer.secure': '🔒 Paiement sécurisé · Stripe',
      'transfer.or_sep': 'ou réserver sans paiement immédiat',
      'transfer.wa': 'Réserver via WhatsApp',
      'transfer.qr_notice_html': 'Un <strong>QR code obligatoire</strong> vous sera remis après paiement — à présenter au conducteur sans exception.',
      ...
      'mad.pay': 'Payer par carte',
      'mad.secure': '🔒 Paiement sécurisé · Stripe',
      'mad.or_sep': 'ou réserver sans paiement immédiat',
      'mad.wa': 'Réserver via WhatsApp',
      'mad.qr_notice_html': 'Un <strong>QR code obligatoire</strong> vous sera remis après paiement — à présenter au conducteur sans exception.',
      ...
      'fleet.title': 'Trois véhicules, un niveau d\'exigence',
      ...
      'fleet.pres_gamme': 'Option Prestige',
      'fleet.pres_desc': 'Le summum de la berline de luxe. Réservée aux clients exigeants, délégations VIP et occasions qui méritent le meilleur. Silence de roulement exceptionnel.',
      ...
      'guar.g6_desc': 'Après paiement, un QR code unique vous est remis. Votre conducteur doit impérativement le scanner avant le départ — sans lui, aucune course ne peut démarrer.',
      ...
      'modal.sub': 'Renseignez vos coordonnées et réglez en toute sécurité.',
      ...
      'modal.card': 'Coordonnées bancaires',
      ...
      'faq.a2_html': 'Le tarif chauffeur privé IsmaDrive est fixé dès la réservation et ne change pas, quelle que soit la circulation. Nos prix démarrent à <strong>1,90 €/km</strong> pour la berline Éco, <strong>3,20 €/km</strong> pour le Business (Classe E) et <strong>4,10 €/km</strong> pour le Van Premium (Classe V). Aucun supplément caché : le prix affiché est le prix payé.',
    ...
    en: {
      ...
      'airport.van_model': 'Mercedes V-Class',
      'airport.business_name': 'Business',
      ...
      'airport.pay': 'Pay by card',
      'airport.secure': '🔒 Secure payment · Stripe',
      'airport.or_sep': 'or book without immediate payment',
      'airport.wa': 'Book via WhatsApp',
      'airport.qr_notice_html': 'A <strong>mandatory QR code</strong> will be sent after payment — must be shown to the driver without exception.',
      ...
      'transfer.pay': 'Pay by card',
      'transfer.secure': '🔒 Secure payment · Stripe',
      'transfer.or_sep': 'or book without immediate payment',
      'transfer.wa': 'Book via WhatsApp',
      'transfer.qr_notice_html': 'A <strong>mandatory QR code</strong> will be sent after payment — must be shown to the driver without exception.',
      ...
      'mad.pay': 'Pay by card',
      'mad.secure': '🔒 Secure payment · Stripe',
      'mad.or_sep': 'or book without immediate payment',
      'mad.wa': 'Book via WhatsApp',
      'mad.qr_notice_html': 'A <strong>mandatory QR code</strong> will be sent after payment — must be shown to the driver without exception.',
      ...
      /* ── Flotte ── */
      'fleet.tag': 'Our fleet',
      'fleet.title': 'Three vehicles, one standard of excellence',
      ...
      'fleet.pres_gamme': 'Prestige option',
      'fleet.pres_desc': 'The pinnacle of the luxury saloon. Reserved for discerning clients, VIP delegations and occasions that deserve the best. Exceptional ride silence.',
      ...
      'guar.g6_desc': 'After payment, a unique QR code is issued to you. Your driver must scan it before departure — without it, no ride can begin.',
      ...
      'modal.sub': 'Enter your details and pay securely.',
      'modal.total': 'Total to pay',
      ...
      'modal.qr_warning_html': 'This QR code is <strong>essential</strong>: your driver cannot start the ride without scanning it. Without presenting the QR code, the pick-up cannot take place.',
      ...
      'faq.a2_html': 'IsmaDrive rates are fixed at booking and never change regardless of traffic. Our prices start at <strong>€1.90/km</strong> for the Eco saloon, <strong>€3.20/km</strong> for Business (E-Class) and <strong>€4.10/km</strong> for the Premium Van (V-Class). No hidden surcharges: the displayed price is the price paid.',
