(function () {
  ...
  var T = {
    fr: {
      ...
      'airport.cdg_name': 'Forfait Paris · Aéroport CDG',
      'airport.orly_name': 'Forfait Paris · Aéroport Orly',
      ...
      'airport.business_model': 'Mercedes Classe E et équivalent',
      'spec.van_pax': '👤 7 places',
      'spec.bus_pax': '👤 3 places',
      'spec.van_bags': '🧳 8 bag.',
      'spec.bus_bags': '🧳 3 bag.',
      'spec.baby_seat': '👶 Siège bébé ✓',
      'spec.family': '👶 Famille ✓',
      'airport.family_label': 'Équipement famille',
      'airport.dir_label': 'Sens du trajet',
      'airport.dir_from': '✈ Depuis l\'aéroport → votre adresse',
      'airport.dir_to': '🏠 Votre adresse → aéroport',
      'airport.addr_label': 'Votre adresse de prise en charge',
      'airport.addr_ph': 'Ex : 10 rue de la Paix, Paris',
      'airport.return_addr_label': 'Adresse de retour',
      'airport.return_addr_ph': 'Ex : 10 rue de la Paix, Paris',
      ...
      'transfer.airport_block_title': '✈ Ce trajet concerne un aéroport',
      'transfer.airport_block_body': 'Le Transfert est réservé aux trajets sans aéroport. Pour CDG et Orly, utilisez le <strong>Forfait Aéroport</strong> — prix fixe, aucun supplément.',
      'transfer.airport_block_cta': 'Voir le Forfait Aéroport →',
      ...
      'tarifs.tag': 'Tarifs',
      'tarifs.title': 'Prix fixes & transparents',
      'tarifs.tab_airport': 'Aéroports',
      'tarifs.tab_transfer': 'Transferts',
      'tarifs.tab_mad': 'Mise à disposition',
      'tarifs.col_route': 'Trajet / Service',
      'tarifs.col_van': 'Van Premium (7 pl.)',
      'tarifs.col_biz': 'Business (3 pl.)',
      'tarifs.fixed_sub': 'Forfait fixe · Aller ou retour',
      'tarifs.cdg_dest': 'Aéroport CDG ↔ Paris',
      'tarifs.orly_dest': 'Aéroport Orly ↔ Paris',
      'tarifs.airport_note': '✓ 60 min d\'attente offertes · Suivi de vol en temps réel · Pancarte nominative incluse',
      'tarifs.km_sub': 'Prix au kilomètre · min. garanti',
      'tarifs.transfer_dest': 'Hors Île-de-France',
      'tarifs.van_km': '2,50 €/km',
      'tarifs.van_min': 'Min. 40 €',
      'tarifs.biz_km': '2,50 €/km',
      'tarifs.biz_min': 'Min. 30 €',
      'tarifs.transfer_note': '✓ Devis gratuit pour toute destination · Versailles, Deauville, Reims, Lyon et toute la France',
      'tarifs.mad_sub': 'Tarif horaire · min. 2h · km illimités',
      'tarifs.mad_dest': 'Mise à disposition',
      'tarifs.mad_note': '✓ Idéal pour visites Paris, excursions Versailles, soirées, événements · Kilométrage illimité',
      ...
      'ap.sub': 'Plus de 10 ans à transporter des femmes et des hommes exigeants dans Paris et l\'Île-de-France. La ponctualité n\'est pas un argument de vente — c\'est un engagement que nous tenons chaque jour, en équipe.',
      ...
      'ap.story_title_html': 'Notre histoire,<br><em>voici qui nous sommes.</em>',
      'ap.p1': 'Nous exerçons le métier de chauffeur privé VTC depuis plus de dix ans. Ce n\'est pas un emploi que nous avons choisi par hasard — c\'est une vocation que nous avons construite trajet après trajet, client après client.',
      'ap.p2': 'Tout a commencé en région parisienne, avec une simple conviction : que le transport privé peut — et doit — être synonyme de sérénité. Pas de stress pour trouver un taxi de nuit, pas de compteur qui s\'emballe, pas d\'incertitude sur l\'heure d\'arrivée. Juste une équipe qui est là, à l\'heure, avec le sourire.',
      'ap.p3': 'Au fil des années, nous avons accompagné des cadres dirigeants vers des rendez-vous décisifs, des familles à l\'aéroport à 4h du matin, des mariés le jour de leur vie. Chaque course est différente, et c\'est ce qui nous passionne depuis le premier jour.',
      'ap.p4': 'Nous sommes titulaires de nos cartes professionnelles VTC, nous conduisons en Mercedes et nous nous engageons sur une chose que nous ne négocions jamais : la ponctualité. Si nous vous confirmons 7h15, nous sommes devant chez vous à 7h10.',
      'ap.p5': 'Notre ligne reste disponible 7j/7. Nous répondons toujours — même le dimanche, même à minuit. Parce qu\'un service VTC fiable, c\'est d\'abord une équipe sur laquelle on peut compter.',
      'ap.sign': '— L\'équipe IsmaDrive',
      'ap.wa_btn': 'Nous contacter sur WhatsApp',
      'ap.values_title': 'Ce en quoi nous croyons',
      'ap.v1_title': 'Ponctualité sans compromis',
      'ap.v1_desc': 'Nous sommes là avant vous. Toujours. Aucune excuse ne justifie un retard quand quelqu\'un a un avion à prendre.',
      'ap.v2_title': 'Discrétion absolue',
      'ap.v2_desc': 'Ce qui se dit dans la voiture reste dans la voiture. Nous n\'avons jamais commenté une conversation d\'affaires ou une confidence personnelle.',
      ...
      /* ── Wizard ── */
      'wizard.trip_mode_label': 'Type de réservation',
      'wizard.round_trip': 'Aller-retour',
      'wizard.one_way': 'Aller simple',
      'wizard.split_dates': 'Dates séparées',
      'wizard.return_datetime': '↩ Date et heure de retour',
      'wizard.return_date_lbl': 'Date retour',
      'wizard.return_time_lbl': 'Heure retour',
      'wizard.outbound_date': 'Date aller',
      'wizard.outbound_time': 'Heure aller',
      'wizard.add_service': 'Ajouter une prestation',
      'wizard.service2_title': '2ème prestation',
      'wizard.service2_remove': '✕ Supprimer',
      'wizard.s2_airport_name': 'Forfait Aéroport',
      'wizard.s2_airport_sub': 'CDG · Orly · Prix fixe',
      'wizard.s2_transfer_name': 'Transfert',
      'wizard.s2_transfer_sub': 'Prix au km',
      'wizard.s2_mad_name': 'Mise à dispo',
      'wizard.s2_mad_sub': 'À l\'heure',
      'wizard.s2_airport_label': 'Aéroport',
      'wizard.s2_from_airport': '✈ Depuis l\'aéroport',
      'wizard.s2_to_airport': '🏠 Vers l\'aéroport',
      'wizard.s2_km_note': 'Prix calculé au km après saisie des adresses',
      'wizard.service2_label': 'Prestation 2',
      'wizard.s2_dep_label': 'Adresse de départ',
      'wizard.s2_arr_label': 'Adresse d\'arrivée',
      'wizard.s2_pickup_label': 'Adresse de prise en charge',
      'wizard.s2_service_label': 'Prestation',
      'wizard.s2_service_price_label': 'Prix prestation',
      'wizard.s2_price_calculating': 'Calcul…',
      'wizard.s2_price_enter_addr': 'Saisissez les adresses',
      'wizard.s2_veh_note': 'Prix définitif selon le véhicule choisi à l\'étape suivante',
      'wizard.s2_from_airport_recap': 'depuis aéroport',
      'wizard.s2_to_airport_recap': 'vers aéroport',
      'wizard.s2_return_prefix': 'Retour : ',
      'wizard.s2_mad_recap': 'Mise à disposition',
      'wizard.s2_cdg_name': 'Aéroport CDG',
      'wizard.s2_orly_name': 'Aéroport Orly',
      'wizard.s2_date_label': 'Date',
      'wizard.s2_time_label': 'Heure',
      'recap.route': 'Trajet',
      'recap.type': 'Type',
      'recap.vehicle': 'Véhicule',
      'recap.outbound_date': 'Date aller',
      'recap.return_date': 'Date retour',
      'recap.equipment': 'Équipement',
      'recap.departure': 'Départ',
      'recap.arrival': 'Arrivée',
      'recap.pickup': 'Prise en charge',
      'recap.datetime': 'Date / Heure',
      'recap.duration': 'Durée',
      'recap.booster': 'Réhausseur enfant',
      'recap.baby_seat': 'Siège bébé',
      'recap.hour': 'heure',
      'recap.hours': 'heures',
      'recap.hourly_rate': 'Tarif horaire',
      'recap.package': 'Forfait',
      'recap.distance': 'Distance',
      'recap.return_addr': 'Adresse retour',
      'recap.family_equip': 'Équipement famille',
      'recap.total_ttc': 'Total TTC',
      'recap.transfer': 'Transfert',
      'recap.price': 'Prix',
      'wizard.your_trip': 'Quel type de trajet ?',
      'wizard.your_vehicle': 'Votre véhicule',
      'wizard.step1_label': 'Trajet',
      'wizard.step2_label': 'Coordonnées',
      'wizard.step3_label': 'Paiement',
      'btn.next': 'Suivant',
      'btn.back': 'Retour',
      'btn.recalculate': 'Recalculer',
      'wizard.secure_line': 'Paiement sécurisé · Stripe · Confirmation par email',
      'extra.outside_paris': 'Hors Paris',
    ...
    en: {
      ...
      'airport.cdg_name': 'Paris Package · CDG Airport',
      'airport.orly_name': 'Paris Package · Orly Airport',
      'airport.oneway': 'One way or return',
      'airport.van_name': 'Premium Van',
      'airport.van_model': 'Premium Van · 7 seats',
      'airport.business_name': 'Business',
      'airport.business_model': 'Mercedes E-Class & equivalent',
      'spec.van_pax': '👤 7 pax',
      'spec.bus_pax': '👤 3 pax',
      'spec.van_bags': '🧳 8 bags',
      'spec.bus_bags': '🧳 3 bags',
      'spec.baby_seat': '👶 Baby seat ✓',
      'spec.family': '👶 Family ✓',
      'airport.dir_label': 'Journey direction',
      'airport.dir_from': '✈ From airport → your address',
      'airport.dir_to': '🏠 Your address → airport',
      'airport.addr_label': 'Your pick-up address',
      'airport.addr_ph': 'E.g. 10 rue de la Paix, Paris',
      'airport.return_addr_label': 'Return address',
      'airport.return_addr_ph': 'E.g. 10 rue de la Paix, Paris',
      ...
      'transfer.airport_block_title': '✈ This trip involves an airport',
      'transfer.airport_block_body': 'The Transfer service is for non-airport trips only. For CDG and Orly, please use the <strong>Airport Package</strong> — fixed price, no surcharges.',
      'transfer.airport_block_cta': 'View Airport Package →',
      ...
      'tarifs.tag': 'Pricing',
      'tarifs.title': 'Fixed & transparent rates',
      'tarifs.tab_airport': 'Airports',
      'tarifs.tab_transfer': 'Transfers',
      'tarifs.tab_mad': 'Hourly hire',
      'tarifs.col_route': 'Route / Service',
      'tarifs.col_van': 'Premium Van (7 seats)',
      'tarifs.col_biz': 'Business (3 seats)',
      'tarifs.fixed_sub': 'Fixed rate · One way or return',
      'tarifs.cdg_dest': 'CDG Airport ↔ Paris',
      'tarifs.orly_dest': 'Orly Airport ↔ Paris',
      'tarifs.airport_note': '✓ 60 min free waiting · Real-time flight tracking · Name sign meet & greet included',
      'tarifs.km_sub': 'Per kilometre · guaranteed minimum',
      'tarifs.transfer_dest': 'Outside Île-de-France',
      'tarifs.van_km': '€2.50/km',
      'tarifs.van_min': 'Min. €40',
      'tarifs.biz_km': '€2.50/km',
      'tarifs.biz_min': 'Min. €30',
      'tarifs.transfer_note': '✓ Free quote for any destination · Versailles, Deauville, Reims, Lyon and across France',
      'tarifs.mad_sub': 'Hourly rate · min. 2h · unlimited km',
      'tarifs.mad_dest': 'Hourly hire',
      'tarifs.mad_note': '✓ Perfect for Paris tours, Versailles excursions, evenings, events · Unlimited mileage',
      ...
      'ap.sub': 'More than 10 years transporting discerning men and women across Paris and Île-de-France. Punctuality is not a selling point — it is a commitment our team upholds every day.',
      'ap.badge': 'Professional VTC Licence',
      'ap.stat1_lbl': 'years of experience',
      'ap.stat2_lbl': 'trips completed',
      'ap.stat3_lbl': 'available 24/7',
      'ap.story_title_html': 'Our story,<br><em>who we are.</em>',
      'ap.p1': 'We have been private VTC chauffeurs for over ten years. This is not a job we stumbled into — it is a vocation we built ride by ride, client by client.',
      'ap.p2': 'It all started in the Paris region, with one simple conviction: that private transport can — and should — mean serenity. No stress finding a late-night taxi, no meter running, no uncertainty about arrival time. Just a team that is there, on time, with a smile.',
      'ap.p3': 'Over the years we have accompanied senior executives to decisive meetings, families to the airport at 4 in the morning, newlyweds on the most important day of their lives. Every ride is different, and that is what has kept us passionate since day one.',
      'ap.p4': 'We hold our professional VTC licences, we drive Mercedes vehicles, and we commit to one thing we never negotiate: punctuality. If we confirm 7:15, we are outside your door at 7:10.',
      'ap.p5': 'Our line stays open 7 days a week. We always answer — even on Sunday, even at midnight. Because a reliable private chauffeur service is, above all, a team you can count on.',
      'ap.sign': '— The IsmaDrive team',
      'ap.wa_btn': 'Contact us on WhatsApp',
      'ap.values_title': 'What we believe in',
      'ap.v1_title': 'Punctuality, no compromise',
      'ap.v1_desc': 'We are there before you. Always. No excuse justifies a delay when someone has a plane to catch.',
      'ap.v2_title': 'Absolute discretion',
      'ap.v2_desc': 'What is said in the car stays in the car. We have never commented on a business conversation or a personal confidence.',
      ...
      /* ── Wizard ── */
      'wizard.trip_mode_label': 'Booking type',
      'wizard.round_trip': 'Round trip',
      'wizard.one_way': 'One way',
      'wizard.split_dates': 'Split dates',
      'wizard.return_datetime': '↩ Return date & time',
      'wizard.return_date_lbl': 'Return date',
      'wizard.return_time_lbl': 'Return time',
      'wizard.outbound_date': 'Outbound date',
      'wizard.outbound_time': 'Outbound time',
      'wizard.add_service': 'Add a service',
      'wizard.service2_title': '2nd service',
      'wizard.service2_remove': '✕ Remove',
      'wizard.s2_airport_name': 'Airport Package',
      'wizard.s2_airport_sub': 'CDG · Orly · Fixed rate',
      'wizard.s2_transfer_name': 'Transfer',
      'wizard.s2_transfer_sub': 'Per km',
      'wizard.s2_mad_name': 'Hourly hire',
      'wizard.s2_mad_sub': 'Per hour',
      'wizard.s2_airport_label': 'Airport',
      'wizard.s2_from_airport': '✈ From airport',
      'wizard.s2_to_airport': '🏠 To airport',
      'wizard.s2_km_note': 'Price calculated per km after entering addresses',
      'wizard.service2_label': 'Service 2',
      'wizard.s2_dep_label': 'Pick-up address',
      'wizard.s2_arr_label': 'Drop-off address',
      'wizard.s2_pickup_label': 'Pick-up address',
      'wizard.s2_service_label': 'Service',
      'wizard.s2_service_price_label': 'Service price',
      'wizard.s2_price_calculating': 'Calculating…',
      'wizard.s2_price_enter_addr': 'Enter addresses',
      'wizard.s2_veh_note': 'Final price based on vehicle selected in next step',
      'wizard.s2_from_airport_recap': 'from airport',
      'wizard.s2_to_airport_recap': 'to airport',
      'wizard.s2_return_prefix': 'Return: ',
      'wizard.s2_mad_recap': 'Hourly hire',
      'wizard.s2_cdg_name': 'CDG Airport',
      'wizard.s2_orly_name': 'Orly Airport',
      'wizard.s2_date_label': 'Date',
      'wizard.s2_time_label': 'Time',
      'recap.route': 'Route',
      'recap.type': 'Type',
      'recap.vehicle': 'Vehicle',
      'recap.outbound_date': 'Outbound date',
      'recap.return_date': 'Return date',
      'recap.equipment': 'Equipment',
      'recap.departure': 'Departure',
      'recap.arrival': 'Arrival',
      'recap.pickup': 'Pick-up',
      'recap.datetime': 'Date / Time',
      'recap.duration': 'Duration',
      'recap.booster': 'Child booster',
      'recap.baby_seat': 'Baby seat',
      'recap.hour': 'hour',
      'recap.hours': 'hours',
      'recap.hourly_rate': 'Hourly rate',
      'recap.package': 'Package',
      'recap.distance': 'Distance',
      'recap.return_addr': 'Return address',
      'recap.family_equip': 'Family equipment',
      'recap.total_ttc': 'Total',
      'recap.transfer': 'Transfer',
      'recap.price': 'Price',
      'wizard.your_trip': 'What type of journey?',
      'wizard.your_vehicle': 'Your vehicle',
      'wizard.step1_label': 'Journey',
      'wizard.step2_label': 'Your details',
      'wizard.step3_label': 'Payment',
      'btn.next': 'Next',
      'btn.back': 'Back',
      'btn.recalculate': 'Recalculate',
      'wizard.secure_line': 'Secure payment · Stripe · Email confirmation',
      'extra.outside_paris': 'Outside Paris',
