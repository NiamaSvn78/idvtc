...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:4px;overflow:hidden;border:1px solid #e8e8e8">
  ...
  <tr><td style="padding:28px 32px 20px">
    ...
    <div style="background:#080808;border:1px solid #c9a96e;border-radius:3px;padding:22px;text-align:center;margin-bottom:16px">
      ...
      <img src="${appUrl}/api/reservations/${r.id || ''}/qrcode" width="200" height="200" alt="QR code réservation IsmaDrive" style="display:block;margin:0 auto;border:4px solid #fff;border-radius:2px"/>
    ...
    ${r.cancellationToken ? `<div style="text-align:center;margin-bottom:18px">${`<a href="${appUrl}/annuler-reservation?token=${encodeURIComponent(r.cancellationToken)}" style="color:#bbb;font-size:11px;text-decoration:underline">Annuler ma réservation</a>`}</div>` : ''}
...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:4px;overflow:hidden;border:1px solid #e8e8e8">
  ...
  <tr><td style="padding:28px 32px 20px">
    ...
    <div style="background:#080808;border:1px solid #c9a96e;border-radius:3px;padding:22px;text-align:center;margin-bottom:16px">
      ...
      <img src="${appUrl}/api/reservations/${r.id || ''}/qrcode" width="200" height="200" alt="IsmaDrive booking QR code" style="display:block;margin:0 auto;border:4px solid #fff;border-radius:2px"/>
    ...
    ${r.cancellationToken ? `<div style="text-align:center;margin-bottom:18px"><a href="${appUrl}/annuler-reservation?token=${encodeURIComponent(r.cancellationToken)}" style="color:#bbb;font-size:11px;text-decoration:underline">Cancel my booking</a></div>` : ''}
